    <!-- Page content -->
    <?php include 'app/controller/infografik_org/post.php'; ?>
        ...
        <div class="col-xl-12">
          <div class="card ">
            ...
            <?php
                ...
                ?>
            <button type="button" class="btn btn-primary mb-5" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus-square"></i> Infografik</button>
                <table class="table table-hover table-flush mt-4" id="datatable1">
                  ...
                  <tbody class="list">
                      <?php tampil_infoorg($id,$base_url,$mysqli);?>
                  </tbody>
                </table>
            </div>
          </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
          ...
          <div class="modal-content">
            <div class="modal-header bg-primary">
              <h6 class="modal-title text-white" id="modal-title-default">Input Infografik</h6>
            ...
            <div class="modal-footer">
              <button type="submit" name="simpan_infografik" class="btn btn-primary"><i class="fas fa-save"></i> Simpan</button>
