          ...
          <div class="card shadow border-0 mb-0" style="margin-top: 50px;">
            ...
            <div class="px-lg-3 py-lg-3">
              <div class="text-center text-muted mb-4">
                <h5>Lupa Password ?</h5>
                <img src="<?= $base_url ?>public/assets/img/verif.png" width="200" alt="">
              </div>
              <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="konfirmasi" class="form-control" placeholder="Password Baru">
                </div>
              ...
              <?php
                if(isset($_POST['kirim'])){
                    ...
                    if($pass == $konfirmasi){
                        ...
                        $mysqli->query("UPDATE organisasi SET pass = '$ps' WHERE email = '$email'");
                        echo '<script>alert("Berhasil mereset katasandi"); window.location.href="'.$base_url.'"</script>';
                    }else{
