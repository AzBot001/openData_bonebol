  ...
  <div class="page-section">
    <div class=" container">
      <div class="row">
        ...
        <div class="col-12 mt-4">Temukan kumpulan data-data mentah berupa tabel yang bisa diolah lebih lanjut di sini. Open Data Bone Bolango menyediakan akses ke beragam koleksi dataset dari seluruh Organisasi Perangkat Daerah di Kabupaten Bone Bolango.</div>
      </div>
          ...
          <div class="d-flex mt-4">
            <div class="input-group mb-3">
              ...
              <div class="input-group-prepend">
                  <button type="submit" name="cari_dataset" value="cari" class="rounded-right btn btn-light"><i class="fas fa-search"></i></button>
              </div>
            </div>
          </div>
          </form>
